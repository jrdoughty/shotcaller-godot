...
@export var do_distribution := false :
	get:
		return do_distribution # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_do_distribution
